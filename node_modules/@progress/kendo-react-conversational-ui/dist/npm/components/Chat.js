...
var Chat = /** @class */ (function (_super) {
    ...
    function Chat(props) {
        ...
        _this.onMessageSend = function (message, event) {
            kendo_react_common_1.dispatchEvent(_this.props.onMessageSend, event, _this, { message: message });
        };
        _this.onActionExecute = function (action, event) {
            kendo_react_common_1.dispatchEvent(_this.props.onActionExecute, event, _this, { action: action });
    ...
    Chat.prototype.getClassNames = function () {
        return kendo_react_common_1.classNames('k-widget', 'k-chat', this.props.className, { 'k-rtl': this.isDirectionRightToLeft });
    };
    ...
    Chat.prototype.getViewItemsFromMsgs = function (msgs) {
        return msgs.length > 0 ? ViewItem_1.convertMsgsToViewItems(msgs) : [];
    };
    /**
     * @hidden
     */
